...
$i++;
$cfg['Servers'][$i]['host']          = 'mysql.themaxx.com'; // MySQL hostname
...
$cfg['Servers'][$i]['user']          = 'fleece';      // MySQL user
$cfg['Servers'][$i]['password']      = 'db_password_goes_here';          // MySQL password (only needed
